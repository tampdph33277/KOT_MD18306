...
class Cart : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            GreetingCart(NavController(context = LocalContext.current))
        }
    }
}

@Composable
fun GreetingCart(navController: NavController) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .padding(10.dp)
        ...
        Column(
            ...
            Row(
                modifier = Modifier
                    ...
                    .padding(horizontal = 20.dp) // Thêm khoảng cách padding hai bên
            ) {
                Text(
                    text = "My cart",
                    fontFamily = FontFamily.Serif,
                ...
                Spacer(modifier = Modifier.weight(2.2f)) // Spacer chiếm khoảng trống ở giữa
                Text(
                    text = "$ 95.00",
                    fontFamily = FontFamily.Serif,
                    color = Color(0xff000000),
